# This file was *autogenerated* from the file m3p9.sage.
...
def m3p9(m=None):
	...
	w = m[_sage_const_0 , _sage_const_0 ]
	n = Node(root, _sage_const_0 , _sage_const_0 , w)
	...
	while True:
		...
		if node.c == m.ncols() - _sage_const_1  and node.r == m.nrows() - _sage_const_1 :
			return weight
